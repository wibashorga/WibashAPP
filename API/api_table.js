...
wibash:{
    ...
    ypepin:{
        read:{
            ...
            liste_categories_taches:{url:ypepin_prefix+"Read/ListeCategoriesTaches.php",args:["id", "pass", "id_projet"]},
        ...
        update:{
            ...
            update_actu:{url: ypepin_prefix+"Update/UpdateActu.php", args:[/**to be continued */]}
        },
        delete:{
